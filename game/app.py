...
class App:
    ...
    def _draw_battle_arena(self):
        ...
        big_player = pygame.transform.smoothscale(self.player_sprite, (128, 128))
        big_npc = pygame.transform.smoothscale(self.npc_sprite, (128, 128))
    ...
    def _draw_sprite(self, sprite, wx, wy):
        ...
        if zoom_scale != 1.0:
            size = max(1, int(round(sprite.get_width() * zoom_scale)))
