...
COLOR_EXPANDED_FILL = (51, 153, 255, 120)
COLOR_EXPANDED_BORDER = (51, 153, 255, 100)
COLOR_PATH = (255, 217, 26)
COLOR_PATH_NODE = (255, 230, 90)

# Warna panel debug overlay (dark mode)
DEBUG_PANEL_BG = (18, 20, 28, 220)
DEBUG_PANEL_BORDER = (60, 130, 220, 180)
DEBUG_TEXT_PRIMARY = (240, 242, 250)
DEBUG_TEXT_SECONDARY = (160, 170, 195)
DEBUG_TEXT_HIGHLIGHT = (80, 190, 255)
DEBUG_TEXT_WARN = (255, 200, 60)
DEBUG_DROPDOWN_BG = (22, 24, 32, 235)
DEBUG_DROPDOWN_HOVER = (40, 80, 140, 200)
DEBUG_DROPDOWN_SELECTED = (30, 100, 200, 220)